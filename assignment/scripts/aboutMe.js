...
let introduction = 'My name is' + firstName + lastName + ',' + 'i think ' + luckyNumber + 'is a winner!';
...
} else luckyResult = 'Luck is what happens when preparation meets opportunity'
console.log(luckyResult)

// 17 -- Rewrite question 12 with a `ternary` operator. You'll need to do research!

function findResult (adventurous){
